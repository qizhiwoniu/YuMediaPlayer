...
public:
    ...
    // 设置 WindowGUI 指针，用于"显示主窗口"时调用
    void SetWindowGUI(YuMediaPlayer::WindowGUI* windowGUI) { m_windowGUI = windowGUI; }
...
private:
    ...
    bool                    m_created;
    YuMediaPlayer::WindowGUI* m_windowGUI;  // 指向 WindowGUI 的指针
